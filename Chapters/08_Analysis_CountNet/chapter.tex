...
\begin{shaded}
This chapter was previously published in~\cite{stoeter18, stoeter19} and is reprinted, with minor modifications, with permission (\textsuperscript{\textregistered} 2019 IEEE). The publication was a result of collaboration with Soumitro Chakrabarty and Emanuël Habets. 
...
Emanuël Habets revised the article and .
\end{shaded}

% © 2019 IEEE. Reprinted, with permission, from ~\cite{stoeter18, stoeter19}]
