\chapter[Estimating the Maximum Number of Concurrent Speakers]{CountNet:  Estimating the Maximum Number of Concurrent Speakers]}
\label{cha:countnet}

\marginpar{This chapter is based on the work that has been published in~\cite{stoeter18, stoeter19} together with Soumitro Chakrabarty and Emanuël Habets. The contributions and experiments my own work and the co-authors mainly helped with ideas and writing.}

% TODO: add confusion matrix and chapter scatter plot
...
% TODO: am besten aus Wolfgangs Arbeit nehmen!
...
\end{equation}
% TODO: to which case does this match in chapter 2
%
...
% TODO: wrap things up here, describe the ouput shape dimensions and the temporal resolution.
...
% TODO: Counting for meeting room scenario of non-overlapping sounds
% TODO: WE tried on music, but it was not able to train. We used the musicnet dataset.
% training count error of 0.2, but a validation error of more than 2 (20 times higher than for speaker count). Poission, non negative binomial distribution....
% TODO: Write in 06 that I tested redundancy reduction but it didn't work and cft is like JPG!
% TODO: Context length is that makes the problem difficult and easy.
