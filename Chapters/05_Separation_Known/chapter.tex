...
\marginpar{This chapter is based on the works that has been submitted to DaFX conference in 2014~\cite{stoeter14} together with my collegues Stefan Bayer and to EUSIPCO 2015~\cite{stoeter15icassp} together with my collegue Nils Werner. Both publications were based on my original ideas.}
...
\subsection{Pitch Variation Informed Source Separation}
...
\section{$F0$ informed Music Separation} % (fold)
\label{sec:method}
