...
In this chapter, we highlighted the time-varying aspects of musical sources such as vibrato for the use in source separation applications.
To address this scenario, we developed a method that utilizes time warping to extract a source from the mixture.
...
% TODO: We showed that warping based separation showed to produce limited results but