...
Before we present our proposed method in the next section, the following paragraphs from~\cite{rafii} (Section IIIb), give a comprehensive overview of existing methods in this field:
