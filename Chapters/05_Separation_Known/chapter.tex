...
This is exploited in many unsupervised algorithms like non-negative matrix factorization (NMF) to approximate the mixture from a lower-rank decomposition in an unsupervised way.
\par
...
The full procedure is depicted in Figure~\ref{fig:warp_demo}.
