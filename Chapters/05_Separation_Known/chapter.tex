...
As mentioned in the previous section, the voice activity detection part is of paramount importance for the proposed music separation system.
Therefore, I decided to evaluate if the robustness of the system can be improved by using a more advanced voice activity detection system as a separate preprocessing step.
\par
