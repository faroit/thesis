...
The dataset is still small in comparison to machine learning sets from vision such as~\ref{imagenet09}, but it proved to be large enough to help DNN-based methods to reach breakthrough results in source separation~\cite{stoeter18sisec}.
\par
