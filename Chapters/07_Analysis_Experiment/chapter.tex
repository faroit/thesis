...
He presented an experiment to quickly infer the number objects (beans) and came up with the hypothesis that humans can instantly estimate the number of objects without actually counting and therefore identifying them.
...
\marginpar{This chapter is based on the work that has been published in~\cite{stoeter19} together with Soumitro Chakrabarty and Emanuël Habets.}
