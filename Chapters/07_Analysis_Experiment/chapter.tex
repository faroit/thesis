...
\begin{shaded}
This section was previously published in~\cite{stoeter19} and is reprinted, with minor modifications, with permission (\textsuperscript{\textregistered} 2019 IEEE). 
\end{shaded}
