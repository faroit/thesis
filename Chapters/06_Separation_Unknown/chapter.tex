...
\section{The Common Fate Model of Unison Mixtures}
...
% TODO: add complexity analysis and plot maybe?
...
\par
Relating our results of STO1 and STO2 to the other methods, we observe that the performance was only slightly below the state-of-the-art performance of UHL and NUG.
...
This changed when over the course of 2015/2016, other researchers successfully proved the superiority of supervised learning based methods for separation (See SiSEC 2015~\cite{ono15}).
...
We showed that the CFT improved separation quality compared to STFT in fully connected deep neural network.
...
\par
A promising route for future work would be to evaluate modern DNN architectures that are specifically designed to deal with higher dimensional data such as the 4D CFT such as capsule network or multidimensional convolutional networks.
