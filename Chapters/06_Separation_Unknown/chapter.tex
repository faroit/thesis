...
\marginpar{This section is based on the work that has been published in~\cite{stoeter16}. The first author mainly contributed to the work. The original idea was developed with Antoine Liutkus.}
...
\marginpar{Parts of this subsection have been published in the SiSEC analysis section of~\cite{rafii} which was co-authored by the author of this thesis.}
