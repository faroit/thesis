...
Even though, I showed that \(F0\)  variation can be estimated from the mixture, often, it is not easy to obtain in practice.
...
\par
Compared to~\cite{barker13}, we chose to generate the modulation tensor in a way that is simpler and easier to invert. 
