...
\par
In the second part of this chapter, we replaced the Common Fate model and instead combined it with an existing deep learning based separation model~\cite{uhlich15}.
