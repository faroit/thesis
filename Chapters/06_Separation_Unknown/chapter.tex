...
For each track, separation results are provided as well as the objective BSSeval scores, all of the data is available via the repository\footnote{\url{https://github.com/faroit/sisec-mus-results}}.
...
\begin{itemize}
  \item DNNs: Super-Frames are computationally too complex and a the same time not flexible enough regarding processing of variable length input. This can be solved by recurrent models. 
