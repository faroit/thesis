...
\par
In our count estimation studies on speech and music (Chapter~\ref{cha:countanalysis}), we showed that humans follow a `one-two-three-many` strategy: we are good at directly inferring small quantities up to four, but we have problems to extrapolate to higher numbers.
