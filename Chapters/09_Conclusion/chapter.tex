...
The combination of separation and count estimation is important since it finally allows to build a real-world separation system, where the number of sources is not known in advance.
