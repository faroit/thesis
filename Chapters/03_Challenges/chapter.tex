...
In turn, a time-frequency representation allows to apply a filter in a way that it sufficiently extracts all targets from the mixture.
...
\begin{quote}
``harmonic relation, the common onset, offset, \acs{AM}, and \acs{FM}. These are all important cues for grouping.''
\end{quote}
...
Furthermore, representations like modulation spectrograms only cover amplitude modulations, whereas general modulation patterns (\acs{AM}/\acs{FM}, timbre modulation) cannot be covered.
\par
