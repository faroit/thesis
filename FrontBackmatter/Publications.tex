...
Chapters 4-8 of this thesis is mainly build on the following publications that I published or submitted during my time as a doctoral student.

Some section in this thesis are based on the work that has been published in~\cite{rafii} as a joint effort to review the state-of-the-art of lead/accompaniment separation. For some of these cited parts, my contribution was minor but I decided that including them, greatly contributes to a more self-contained thesis.
