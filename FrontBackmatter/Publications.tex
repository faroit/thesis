...
This thesis is based on several previously published publications. As such, they are cited repeatedly throughout the remainder of this thesis. 
If a section is mainly based on one of these publications, a remark is added at the side of the page, instead of citing the same publication exhaustively. 
The following is a list of my publications and my own contributions therein, ordered by the first appearance in the chapters of this thesis.
